...
<header class="site-header"><div class="wrap nav"><a href="index.php" class="logo" aria-label="One Source Air and Energy Ltd"><img src="assets/logos/onesource-logo.png" alt="One Source Air & Energy Ltd logo"></a><button class="menu-toggle" aria-label="Open menu">☰</button><nav class="main-nav" aria-label="Main navigation">
        ...
        <a href="about.php" data-page="about" class="active">About Us</a>
...
<main><section class="page-hero"><div class="wrap"><h1>About Us</h1><p>Practical, efficient and professionally installed domestic systems.</p></div></section><section class="section pale"><div class="wrap about-grid"><div class="content-card"><h2>About One Source Air & Energy Ltd</h2><p>We provide domestic air conditioning, solar PV, battery storage, EV charging, electrical and gas services with a focus on quality, safety and tidy workmanship.</p><ul><li>Clear advice before work begins</li><li>Safe and compliant installations</li><li>Reliable communication</li><li>A neat finish in domestic homes</li></ul></div><img class="about-img" src="assets/images/hero-uk-street.svg" alt="UK housing and home energy systems"></div></section></main>
<footer>
