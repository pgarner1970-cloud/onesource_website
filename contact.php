...
<header class="site-header"><div class="wrap nav"><a href="index.php" class="logo" aria-label="One Source Air and Energy Ltd"><img src="assets/logos/onesource-logo.png" alt="One Source Air & Energy Ltd logo"></a><button class="menu-toggle" aria-label="Open menu">☰</button><nav class="main-nav" aria-label="Main navigation">
        ...
        <span class="nav-dropdown"><a href="services.php" data-page="services">Services</a><span class="dropdown-menu"><a href="air-conditioning.php">Air Conditioning</a><a href="solar-pv.php">Solar PV</a><a href="battery-storage.php">Battery Storage</a><a href="ev-chargers.php">EV Chargers</a><a href="electrical-services.php">Electrical Services</a><a href="gas-services.php">Gas Services</a></span></span>
        <a href="our-work.php" data-page="work">Our Work</a>
        <a href="about.php" data-page="about">About Us</a>
        
        <a href="contact.php" data-page="contact" class="active">Contact</a>
...
<main><section class="page-hero"><div class="wrap"><h1>Contact</h1><p>Tell us about your property and the work you need help with.</p></div></section><section class="section contact-section"><div class="wrap contact-grid"><div><p class="label">Start an enquiry</p><h2>Get in touch with One Source.</h2><p>Phone: 07502 216131<br>Email: luke@onesourceairandenergyltd.co.uk</p><p>Cleobury Mortimer, Kidderminster DY14 8DP</p></div><form class="quote-form"><div class="form-row"><label>Name<input type="text" placeholder="Your name"></label><label>Phone<input type="tel" placeholder="Your phone number"></label></div><div class="form-row"><label>Email<input type="email" placeholder="Your email address"></label><label>Service<select><option>Air Conditioning</option><option>Solar PV</option><option>Battery Storage</option><option>EV Charger</option><option>Electrical Services</option><option>Gas Services</option></select></label></div><label>Message<textarea placeholder="Tell us about the property and work required"></textarea></label><button type="button" class="btn btn-primary">Send Enquiry →</button></form>
