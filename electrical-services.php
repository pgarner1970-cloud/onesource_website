...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Electrical Services | One Source Air & Energy Ltd</title><meta name="description" content="Domestic, commercial and industrial electrical installation, upgrades and maintenance from a NICEIC Registered Installer."><link rel="stylesheet" href="assets/css/styles.css">
...
<main><section class="page-hero"><div class="wrap"><h1>Electrical Services</h1><p>Domestic, commercial and industrial electrical installation, upgrades and maintenance from a NICEIC Registered Installer.</p></div></section><section class="section"><div class="wrap content-grid"><article class="content-card"><img class="service-detail-image" data-service-image="electrical" src="assets/images/services/electrical-services.jpg" alt="Electrical Services"><h2>Electrical Services for domestic, commercial and industrial properties</h2><p>Domestic, commercial and industrial electrical installation, upgrades and maintenance from a NICEIC Registered Installer.</p><h3>How we can help</h3><ul><li>Clear advice before work begins</li><li>Safe and tidy installation</li><li>Domestic property focused service</li><li>Ongoing support and maintenance where appropriate</li></ul><a class="btn btn-primary" href="contact.php">Request a Quote →</a></article><aside class="side-nav">
